...
public final class RequestBypassToServer extends L2GameClientPacket
{
    ...
    protected void runImpl()
    {
        ...
        try
        {
            if (_command.startsWith("admin_"))
                ...
                handleManor(player);
            else if (_command.startsWith("bbs_") || _command.startsWith("_bbs") ||
                     _command.startsWith("_friend") || _command.startsWith("_mail") || _command.startsWith("_block"))
    ...
    private void handleAdminCommand(Player player)
    {
        ...
        if (Config.GMAUDIT)
            GMAUDIT_LOG.info(player.getName() + " [" + player.getObjectId() + "] used '" +
                    _command + "' command on: " +
                    ((player.getTarget() != null) ? player.getTarget().getName() : "none"));
